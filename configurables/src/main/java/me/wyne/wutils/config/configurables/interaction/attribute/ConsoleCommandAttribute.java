...
public class ConsoleCommandAttribute extends ConfigurableAttribute<List<String>> implements ContextInteractionAttribute {
    ...
    public ConsoleCommandAttribute(String key, List<String> value) {
        super(key, value);
    }

    public ConsoleCommandAttribute(List<String> value) {
    ...
    public static final class Factory implements AttributeFactory<ConsoleCommandAttribute> {
        @Override
        public ConsoleCommandAttribute create(String key, ConfigurationSection config) {
